...
RPG.module('Gfx', function() {
	...
	function Gfx(AI, PubSub) {
		...
		this.container.on = function(eventName, fn) {
			this.container.addEventListener(eventName, fn.bind(this), false);
		}.bind(this);
		this.joystick.on = function(eventName, fn) {
			this.joystick.addEventListener(eventName, fn.bind(this), false);
		}.bind(this);
